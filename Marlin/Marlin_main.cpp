 ...
 */
inline void gcode_M500(int profile_num) {
  Config_StoreSettings(profile_num);
}

/**
 * M501: Read settings from EEPROM
 */
inline void gcode_M501(int profile_num) {
  Config_RetrieveSettings(profile_num);
}

/**
 * M502: Revert to default settings
 */
inline void gcode_M502(int profile_num) {
 ...
 * M700: Set profile number
 */
inline void gcode_M700(int num) {
    profile_num = num;
}
  ...
  switch(command_code) {
    ...
    case 'M': switch (codenum) {
      ...
      case 500: // M500 Store settings in EEPROM
        gcode_M500(profile_num);
        break;
      case 501: // M501 Read settings from EEPROM
        gcode_M501(profile_num);
        break;
      case 502: // M502 Revert to default settings
        gcode_M502(profile_num);
        break;
