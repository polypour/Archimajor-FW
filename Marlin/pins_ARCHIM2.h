...
#define TMC_SWSPI_MISO_PIN 26
//PD1 MISO
#define TMC_SWSPI_SCK_PIN  27
//PD2 SCK
#define TMC_SWSPI_MOSI_PIN 28
//PD3 MOSI
...
#ifdef ULTRA_LCD
  #define KILL_PIN           -1 
  //Button is connected directly to NRST Hardware Reset Pin on SAM3X
  #ifdef NEWPANEL
