...
/*
  ...
  pinMode(PIN_HSMCI_MCCDA_GPIO_ARDUINO, INPUT_PULLUP);
  pinMode(PIN_HSMCI_MCDA0_GPIO_ARDUINO, INPUT_PULLUP);
  pinMode(PIN_HSMCI_MCDA1_GPIO_ARDUINO, INPUT_PULLUP);
  pinMode(PIN_HSMCI_MCDA2_GPIO_ARDUINO, INPUT_PULLUP);
  pinMode(PIN_HSMCI_MCDA3_GPIO_ARDUINO, INPUT_PULLUP);
*/
  pinMode(PIN_HSMCI_CARD_DETECT_ARDUINO, INPUT_PULLUP);
