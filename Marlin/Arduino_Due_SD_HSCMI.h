...
#include "Arduino.h"
#include "Arduino_Due_SD_HSMCI_Configuration.h"
#include <SD_HSMCI.h>
...
//HSMCI
/*
static const uint8_t PIN_HSMCI_MCCDA_GPIO  = 108; //101;
static const uint8_t PIN_HSMCI_MCCK_GPIO  = 109; //102;
static const uint8_t PIN_HSMCI_MCDA0_GPIO  = 110; //103;
static const uint8_t PIN_HSMCI_MCDA1_GPIO  = 111; //104;
static const uint8_t PIN_HSMCI_MCDA2_GPIO  = 112; //105;
static const uint8_t PIN_HSMCI_MCDA3_GPIO  = 113; //106; */
...
static const uint8_t PIN_HSMCI_CARD_DETECT_ARDUINO = 85;
